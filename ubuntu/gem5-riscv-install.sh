...
sudo $APT_COMMAND install -y build-essential git m4 scons zlib1g zlib1g-dev libprotobuf-dev protobuf-compiler libprotoc-dev libgoogle-perftools-dev python3 python3-dev python3-venv libboost-all-dev automake
